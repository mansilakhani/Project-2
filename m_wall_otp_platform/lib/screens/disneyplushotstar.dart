...
class DisneyplusHotstar extends StatefulWidget {
  const DisneyplusHotstar({Key? key}) : super(key: key);

  @override
  State<DisneyplusHotstar> createState() => _DisneyplusHotstarState();
}

class _DisneyplusHotstarState extends State<DisneyplusHotstar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xff0e1a4c),
